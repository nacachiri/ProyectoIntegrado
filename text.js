...
function main() {
    ...
    function creacionTabla() {
        ...
        divCorazon.style='background-image: url(../logos/logoSolo.png)'
        ...
        let imgGasolinera=document.createElement('img')
        ...
        let divImgConbustible=document.createElement('img')
        divImgConbustible.className='bg-cover bg-center w-10 h-10 rounded-full mr-3'
        divImgConbustible.style='background-image: url(../logos/logoSolo.png)'
        ...
        divgasolinaPrecio.appendChild(pgasolina98)
        divgasolinaPrecio.appendChild(pPrecio)
        ...
        divgasolinaPrecio.appendChild(pDiesel)
        divgasolinaPrecio.appendChild(pPrecio)
        ...
        divgasolinaPrecio.appendChild(pDieselPremium)
        divgasolinaPrecio.appendChild(pPrecio)
